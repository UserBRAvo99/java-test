...
// // знайомство
// const name = prompt(
//     `Привіт, це арифметичний тест. Та для початку давай знайомитися. Напиши своє ім'я`,
//     'Гість             '
// );
...
//     a * b === Number(expressionOne)
//         ? alert(`Вірно, відповідь - ${a * b}.`)
//         : alert(`Не вірно, відповідь - ${a * b}.`);
//     a * b === Number(expressionOne) ? yes.push(1) : no.push(1);
// };
// //віднімання
// const funActionTwo = () => {
//     const expressionTwo = prompt(`${name}, відніми від ${c} - ${d}, та запиши відповідь`);
//     c - d === Number(expressionTwo)
//         ? alert(`Вірно, відповідь - ${c - d}.`)
//         : alert(`Не вірно, відповідь - ${c - d}.`);
...
//     e + f === Number(expressionThree)
//         ? alert(`Вірно, відповідь - ${e + f}.`)
//         : alert(`Не вірно, відповідь - ${e + f}.`);
...
//         }
//     };
//     const expressionFour = prompt(
//         `${name}, поділи число ${Number(h())} навпіл. та запиши відповідь`
//     );
//     Number(h()) / 2 === Number(expressionFour)
//         ? alert(`Вірно, відповідь - ${Number(h()) / 2}.`)
//         : alert(`Не вірно, відповідь - ${Number(h()) / 2}.`);
...
//     i * 10 === Number(expressionFive)
//         ? alert(`Вірно, відповідь - ${i * 10} міліметрів.`)
//         : alert(`Не вірно, відповідь - ${i * 10} міліметрів.`);
...
//     j * 10 === Number(expressionSix)
//         ? alert(`Вірно, відповідь - ${j * 10} сантиметрів.`)
//         : alert(`Не вірно, відповідь - ${j * 10} сантиметрів.`);
...
//     k + l + m === Number(expressionSeven)
//         ? alert(`Вірно, відповідь - ${k + l + m}.`)
//         : alert(`Не вірно, відповідь - ${k + l + m}.`);
...
//     (o() * n) / n === Number(expressionEight)
//         ? alert(`Вірно, відповідь - ${(o() * n) / n}.`)
//         : alert(`Не вірно, відповідь - ${(o() * n) / n}.`);
...
//     } else {
//         return alert(
//             `${name}, молодець! В тебе правильних ${yes.length} відповідей, та ${no.length} помилок.`
//         );
//     }
// };
// sum();
